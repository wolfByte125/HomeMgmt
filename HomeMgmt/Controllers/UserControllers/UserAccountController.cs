...
namespace HomeMgmt.Controllers.UserControllers
{
    ...
    public class UserAccountController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult> ReadUserAccounts([FromQuery] QueryDTO queryDTO, [FromQuery] FilterUserAccountDTO filterDTO)
        {
            try
            {
                return Ok(await _userAccountService.ReadUserAccounts(queryDTO: queryDTO, filterDTO: filterDTO));
            }
            catch (Exception ex)
            {
                return this.ParseException(ex);
